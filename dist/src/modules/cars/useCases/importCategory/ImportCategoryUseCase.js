...
let ImporteCategoryUseCase = class ImporteCategoryUseCase {
    ...
    loadCategories(file) {
        return new Promise((resolve, reject) => {
            ...
            parseFile
                .on("data", ([name, description]) => __awaiter(this, void 0, void 0, function* () {
                categories.push({
                    name,
                    description,
                });
    ...
    execute(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            categories.map(({ name, description }) => __awaiter(this, void 0, void 0, function* () {
                const existsCategory = yield this.categoriesRepository.findByName(name);
                if (!existsCategory) {
...
ImporteCategoryUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("CategoriesRepository")),
    __metadata("design:paramtypes", [CategoriesRepository_1.CategoriesRepository])
